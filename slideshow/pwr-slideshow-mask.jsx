function importSequentialImagesUI() {
    ...
    goBtn.onClick = function () {
      ...
      for (var i = 0; i < files.length; i++) {
        ...
        // Add 720x720 white solid as matte
        var matte = comp.layers.addSolid([1, 1, 1], "Matte_" + i, 1152, 1152, 1);
        matte.property("Position").setValue([compWidth / 2, compHeight / 2]);
  
        // Move matte directly above image layer
