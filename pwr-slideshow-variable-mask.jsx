function importSequentialImagesUI() {
    ...
    win.add("statictext", undefined, "Image Width (pixels):");
    var imageWidthInput = win.add("edittext", undefined, "1000");
    imageWidthInput.characters = 10;
    ...
    goBtn.onClick = function () {
      ...
      var imageWidth = parseFloat(imageWidthInput.text);
      ...
      for (var i = 0; i < files.length; i++) {
        ...
        var scaleFactor = imageWidth / footage.width;
        var newHeight = footage.height * scaleFactor;
        layer.property("Scale").setValue([scaleFactor * 100, scaleFactor * 100]);
        layer.property("Position").setValue([offsetX + imageWidth / 2, offsetY + newHeight / 2]);
